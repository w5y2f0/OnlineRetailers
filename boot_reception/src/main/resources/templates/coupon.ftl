                ...
                <div class="am-tabs-d2 am-tabs  am-margin" data-am-tabs>
                    ...
                    <div class="am-tabs-bd">
                        <div class="am-tab-panel am-fade am-in am-active" id="tab1">
                            ...
                            <#list couponVoList as list>
                                <#if list.reUse==0 && list.reTerm==0>
                                    <div class="coupon-item coupon-item-d">
                                        <div class="coupon-list">
                                            <div class="c-type">
                                                ...
                                                <div class="c-price">
                                                    <strong>￥${list.coMoney}</strong>
                                                </div>
                                                <div class="c-limit">
                                                    【消费满&nbsp;${list.coLimit}元&nbsp;可用】
                                                </div>
                                                <div class="c-time">
                                                    <span>使用期限</span>${list.reTime?string("yyyy-MM-dd")}--${list.coValid?string("yyyy-MM-dd")}
                                                </div>
                                    ...
                                    <div class="coupon-item coupon-item-d">
                                        <div class="coupon-list">
                                            <div class="c-type">
                                                ...
                                                <div class="c-time"><span>使用期限</span>${list.reTime?string("yyyy-MM-dd")}--${list.coValid?string("yyyy-MM-dd")}</div>
                                                <div class="c-type-top"></div>
                                            ...
                                            <div class="c-msg">
                                                ...
                                                <div class="op-btns c-del">
                                                    <a href="javascript:deleteFun(${list.reId})" class="btn"><span class="txt">删除</span><b></b></a>
                                                </div>
                                            </div>
